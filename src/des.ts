...
*/  
function strEnc(data:string,firstKey:string,secondKey:string,thirdKey:string):string{  
  
    var leng = data.length;  
    var encData = "";  
    let firstKeyBt=new Array(),secondKeyBt=new Array(),thirdKeyBt=new Array(),firstLength=0,secondLength=0,thirdLength=0;  
    ...
    if(leng > 0){  
      if(leng < 4){  
        ...
        if(firstKey != null && firstKey !="" && secondKey != null && secondKey != "" && thirdKey != null && thirdKey != ""){  
          ...
          for(let y = 0;y < secondLength ;y ++){  
            tempBt = enc(tempBt,secondKeyBt[y]);  
          }  
          for(let z = 0;z < thirdLength ;z ++){  
        ...
        encData = bt64ToHex(encByte as number[]);  
      }else{  
        var iterator = parseInt((leng/4).toString());  
   ...
   */  
   function strDec(data:string,firstKey:string,secondKey:string,thirdKey:string):string{  
    var leng = data.length;  
    var decStr = "";  
    let firstKeyBt=new Array(),secondKeyBt=new Array(),thirdKeyBt=new Array(),firstLength=0,secondLength=0,thirdLength=0;  
    if(firstKey != null && firstKey != ""){      
    ...
    var iterator = parseInt((leng/16).toString());  
    var i=0;    
    for(i = 0;i < iterator;i++){  
      ...
      decStr += byteToString(decByte as number[]);  
    }        
    return decStr;  
   }  
   /* 
    ...
    if(leng < 4){  
      ...
      for(i = 0;i<leng;i++){  
        ...
        for(j=0;j<16;j++){        
          ...
          bt[16*i+j]=parseInt((k/pow).toString())%2;  
        }  
      }  
      for(p = leng;p<4;p++){  
        var k = 0;  
        for(q=0;q<16;q++){        
          ...
          bt[16*p+q]=parseInt((k/pow).toString())%2;  
        }  
      }    
    }else{  
      for(i = 0;i<4;i++){  
   ...
   * return hex 
   */  
   function bt4ToHex(binary:string) {  
    var hex;  
    switch (binary) {  
   ...
   * return string 
   */  
   function byteToString(byteData:number[]){  
    var str="";  
    for(let i = 0;i<4;i++){  
      var count=0;  
      for(let j=0;j<16;j++){          
   ...
   function bt64ToHex(byteData: number[]){  
    var hex = "";  
    for(let i = 0;i<16;i++){  
      var bt = "";  
      for(let j=0;j<4;j++){      
   ...
   */  
   ...
   function xor(byteOne: number[],byteTwo: number[]){    
   ...
   function pPermute(sBoxByte: number[]){  
   ...
   function getBoxBinary(i:number) {  
    var binary = "";  
    switch (i) {  
      case 0 :binary = "0000";break;  
      case 1 :binary = "0001";break;  
